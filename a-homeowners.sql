...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 15, 2018 at 03:13 PM
...
--
-- Table structure for table `fhjyfjk`
--

CREATE TABLE `fhjyfjk` (
...
INSERT INTO `posts` (`posts_id`, `post`, `comments`) VALUES
(1, '', 'fdfd'),
(2, '', 'sfddsf'),
(3, '', 'sfddsf'),
(4, '', 'sfddsf'),
...
--
-- Constraints for table `fhjyfjk`
--
ALTER TABLE `fhjyfjk`
  ADD CONSTRAINT `fhjyfjk_ibfk_1` FOREIGN KEY (`likes_id`) REFERENCES `likes` (`likes_id`);
...
ALTER TABLE `likes`
  ...
  ADD CONSTRAINT `likes_ibfk_2` FOREIGN KEY (`fk_posts_id`) REFERENCES `fhjyfjk` (`post_id`);
